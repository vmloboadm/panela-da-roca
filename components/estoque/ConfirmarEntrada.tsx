  ...
  return (
    <div className="bg-bg-card rounded-xl p-4 flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        {itens.map((item, i) => (
          <div key={i} className="border border-border rounded-xl p-3 flex flex-col gap-2 bg-bg-card">
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className={[
                  'bg-bg-hover border rounded-lg px-3 py-2 text-text-primary text-sm',
            ...
            <div className="flex gap-2">
              <div className="flex flex-col gap-1 flex-1">
                ...
                <input
                  ...
                  placeholder="0"
                  className="bg-bg-hover border border-border rounded px-2 py-1.5 text-text-primary text-sm"
                />
              </div>
